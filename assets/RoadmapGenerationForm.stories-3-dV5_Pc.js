import{t as e}from"./RoadmapGenerationForm-BNzH8_bo.js";var t={title:`Organisms/RoadmapGenerationForm`,component:e,parameters:{layout:`centered`},tags:[`autodocs`]},n={args:{onGenerate:e=>{console.log(`Generate roadmap with prompt:`,e)},onCancel:()=>{console.log(`Cancel generation`)},isLoading:!1}},r={args:{...n.args,isLoading:!0}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
