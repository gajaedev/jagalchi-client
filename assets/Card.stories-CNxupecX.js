import{j as e}from"./jsx-runtime-aX5MvExf.js";import{C as r,b as c,c as l,d as C,a,e as h,f as p}from"./card-Cfk7NT-x.js";import{B as n}from"./button-BLLC2g74.js";import"./iframe-DvS0hAEM.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-CDN07tui.js";import"./index-CG08QkUq.js";import"./index-DpIOW7F_.js";import"./index-B_jtOnfb.js";const v={title:"UI/Card",component:r,parameters:{layout:"centered"},tags:["autodocs"]},t={render:()=>e.jsxs(r,{className:"w-[350px]",children:[e.jsxs(c,{children:[e.jsx(l,{children:"Card Title"}),e.jsx(C,{children:"Card description goes here"})]}),e.jsx(a,{children:e.jsx("p",{children:"Card content with some text explaining the purpose of this card."})})]})},s={render:()=>e.jsxs(r,{className:"w-[350px]",children:[e.jsxs(c,{children:[e.jsx(l,{children:"Card with Footer"}),e.jsx(C,{children:"This card includes a footer section"})]}),e.jsx(a,{children:e.jsx("p",{children:"Main content of the card."})}),e.jsx(h,{children:e.jsx(n,{variant:"outline",className:"w-full",children:"Action"})})]})},i={render:()=>e.jsxs(r,{className:"w-[350px]",children:[e.jsxs(c,{children:[e.jsx(l,{children:"Card with Action"}),e.jsx(C,{children:"This card has an action button in the header"}),e.jsx(p,{children:e.jsx(n,{variant:"ghost",size:"icon-sm",children:"×"})})]}),e.jsx(a,{children:e.jsx("p",{children:"Card content with header action button."})})]})},d={render:()=>e.jsx(r,{className:"w-[350px]",children:e.jsx(a,{children:e.jsx("p",{children:"A simple card with only content, no header or footer."})})})},o={render:()=>e.jsxs(r,{className:"w-[400px]",children:[e.jsxs(c,{children:[e.jsx(l,{children:"Complete Card"}),e.jsx(C,{children:"A card with all available sections"}),e.jsx(p,{children:e.jsx(n,{variant:"outline",size:"sm",children:"Edit"})})]}),e.jsx(a,{children:e.jsxs("div",{className:"space-y-2",children:[e.jsx("p",{children:"This card demonstrates all available components:"}),e.jsxs("ul",{className:"list-inside list-disc space-y-1 text-sm",children:[e.jsx("li",{children:"CardHeader with title and description"}),e.jsx("li",{children:"CardAction in the header"}),e.jsx("li",{children:"CardContent with structured content"}),e.jsx("li",{children:"CardFooter with action buttons"})]})]})}),e.jsxs(h,{className:"gap-2",children:[e.jsx(n,{variant:"outline",className:"flex-1",children:"Cancel"}),e.jsx(n,{className:"flex-1",children:"Confirm"})]})]})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
