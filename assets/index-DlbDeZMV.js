import{j as s}from"./jsx-runtime-Bh_cePIx.js";import{r as l}from"./iframe-nWJMQWTs.js";import{L as y}from"./label-JC82UBUe.js";import{c as h}from"./utils-CDN07tui.js";const d=l.forwardRef(({label:n,value:p,placeholder:u,onChange:c,isMultiline:r=!1,hasError:e=!1,errorMessage:a,isDisabled:i=!1,className:m},f)=>{const t=l.useId(),o=`${t}-error`,x=v=>{c?.(v.target.value)},g=h("w-full min-h-[36px] px-3 py-[7.5px]","bg-white border border-slate-200 rounded-lg","shadow-sm","text-sm leading-[21px] tracking-[0.07px]","text-[#020617] placeholder:text-slate-500","outline-none transition-colors","focus-visible:border-slate-300 focus-visible:ring-2 focus-visible:ring-slate-100",e&&["border-red-500","focus-visible:border-red-500 focus-visible:ring-red-100"],i&&"opacity-50 cursor-not-allowed pointer-events-none",m),b=r?"textarea":"input";return s.jsxs("div",{className:"flex flex-col gap-1.5",children:[n&&s.jsx(y,{htmlFor:t,className:"text-sm font-medium text-[#020617]",children:n}),s.jsx(b,{ref:f,id:t,value:p,placeholder:u,onChange:x,disabled:i,"aria-invalid":e,"aria-describedby":e&&a?o:void 0,className:g,...r&&{rows:3}}),e&&a&&s.jsx("p",{id:o,className:"text-xs text-red-500",children:a})]})});d.displayName="EditorInput";d.__docgenInfo={description:`에디터 전용 입력 필드 컴포넌트
